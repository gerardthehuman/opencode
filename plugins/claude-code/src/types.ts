...
/**
 * Billing display mode for the OpenCode plugin tuple. This is plugin-level
 * configuration; it is not a Claude Code language-model provider option.
 */
export type ClaudeCodePricing = "subscription" | "enterprise" | "bedrock";
