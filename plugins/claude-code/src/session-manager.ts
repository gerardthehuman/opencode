...
import { cliSupportsThinking, cliSupportsThinkingDisplay, type CliVersion } from "./cli-version.js";
 ...
 * fallback).
 */
export function appendResumeIfNeeded(sessionKey: string, cliArgs: string[]): string[] {
