...
export function resolveSpawnCwd(configured: string | undefined): string {
  return resolveSpawnCwdFrom(configured, process.cwd(), opencodeProjectDirectory);
}
 ...
 */
export async function getRuntimeMcpStatus(): Promise<RuntimeMcpStatus | undefined> {
